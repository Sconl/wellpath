// lib/features/site/home/widgets/site_testimonials.dart
...
class SiteTestimonials extends StatelessWidget {
  final SiteTestimonialsConfig config;
  const SiteTestimonials({super.key, required this.config});
