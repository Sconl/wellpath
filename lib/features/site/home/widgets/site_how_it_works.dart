// lib/features/site/home/widgets/site_how_it_works.dart
...
class SiteHowItWorks extends StatelessWidget {
  final SiteHowItWorksConfig config;
  const SiteHowItWorks({super.key, required this.config});
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      LayoutBuilder(builder: (ctx, constraints) {
        ...
        return Column(
          children: config.steps.map((step) => Padding(
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: AnimatedGradientBorder(
        ...
        // Slightly thinner arc for step cards
        arcFraction:  0.25,
