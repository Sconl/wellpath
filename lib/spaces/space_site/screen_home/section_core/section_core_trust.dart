// lib/spaces/space_site/screen_home/section_core/section_core_trust.dart
//
// QP CANON: SECTION CORE — block core_trust (optional §5.2, screen_entry only)
//
// Renamed from: widgets/site_trusted_strip.dart
...
class SectionCoreTrust extends StatefulWidget {
  final SiteTrustedConfig config;
  const SectionCoreTrust({super.key, required this.config});

  @override
  State<SectionCoreTrust> createState() => _SectionCoreTrustState();
}

class _SectionCoreTrustState extends State<SectionCoreTrust>
