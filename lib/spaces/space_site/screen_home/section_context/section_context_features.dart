// lib/spaces/space_site/screen_home/section_context/section_context_features.dart
//
// QP CANON: SECTION CONTEXT — block context_features
// Renamed from: widgets/site_features.dart
...
class SectionContextFeatures extends StatelessWidget {
  final SiteFeaturesConfig config;
  const SectionContextFeatures({super.key, required this.config});
...
class _FeatureCard extends StatefulWidget {
  final SpaceSiteFeature feature;
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: _hovered ? [BoxShadow(
                color: _accent.withAlpha(30), blurRadius: 20, spreadRadius: 1)] : [],
          ),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(widget.feature.title, style: AppTypography.h4.copyWith(fontSize: 17)),
            SizedBox(height: AppSpacing.sm),
            Text(widget.feature.body, style: AppTypography.bodySmall.copyWith(height: 1.65)),
          ]),
        ),
      ),
    );
